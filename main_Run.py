    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = csv_name = 'C:\\Users\\Paras\\OneDrive\\Documents\\Attenndace_Mangment_AICTE\\Attendance\\Manually Attendance\\' + DB_table_name + '.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\Paras\OneDrive\Documents\Attenndace_Mangment_AICTE\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/Paras/OneDrive/Documents/Attenndace_Mangment_AICTE/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Users\Paras\OneDrive\Documents\Attenndace Mangment-AICTE\Attendance\Physics_2024-11-26_09-37-22.csv"')
    ...
    def log_in():
        ...
        if username == 'prayas':
            if password == 'Prayas8765':
                ...
                cs = 'C:/Users/Paras/OneDrive/Documents/Attenndace_Mangment_AICTE/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
